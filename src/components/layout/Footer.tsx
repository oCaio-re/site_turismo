        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4">
              ...
              <li>
                <Link href="/traslados" className="text-slate-400 hover:text-primary transition-colors inline-flex items-center group font-light">
                  <span className="w-0 group-hover:w-4 overflow-hidden transition-all duration-300 h-px bg-primary mr-0 group-hover:mr-3"></span>
                  Traslados
                </Link>
              </li>
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-5">
              ...
              <li className="flex items-center space-x-4 text-zinc-400">
                ...
                <span className="font-light">info@nerytour.com.br</span>
              </li>
            </ul>
          </div>
